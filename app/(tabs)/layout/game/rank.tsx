  ...
  return (
    <View style={style.container}>
      <View style={style.header}>
        ...
        />
        <Text style={style.headerTitle}>Bảng xếp hạng</Text>
      </View>
        ...
        <View style={style.mainCardContainer}>
          {[2, 1, 3].map((item, index) => {
            return (
              <View
                key={index}
                style={[style.mainCard, item !== 1 && { marginTop: 20 }]}
              >
                <Image
                  ...
                  resizeMode="cover"
                />
                <Text style={style.mainCardTitle}>Vishu</Text>
                {/* <View style={style.mainCardRankContainer}> */}
                  ...
                  {item === 1 ? (
                    <Image
                      ...
                      style={style.mainCardRankContainer}
                    />
                  ) : item === 2 ? (
                    <Image
            ...
            <View style={style.card}>
              <View style={style.cardDataContainer}>
                ...
                <Image
                  ...
                  resizeMode="cover"
                />
                <Text style={style.cardTitle}>Vishu Chaturvedi</Text>
              </View>
              <View style={style.cardRankContainer}>
                <Text style={style.cardRankTitle}>3456,789</Text>
              </View>
            </View>
          );
        }}
      />
      <View style={style.cardbyme}>
          <View style={style.cardDataContainer}>
            <Image
              source={require("../../../../assets/images/png/rewardBear.png")}
              style={style.cardImage}
              resizeMode="cover"
            />
            <Text style={style.cardTitleByMe}>Vishu Chaturvedi (YOU)</Text>
          </View>
          <View style={style.cardRankContainer}>
            <Text style={style.cardRankTitle}>3456,789</Text>
          </View>
